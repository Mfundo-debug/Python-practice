...
def maxwell_algorithm(graph, start, end):
    """
    Find the shortest path between two points in a graph using maxwell's equations.
    """
...
if __name__ == '__main__':
    ...
    shortest_path = maxwell_algorithm(graph, start, end)
    print(f'The shortest path between {start} and {end} is {shortest_path}')