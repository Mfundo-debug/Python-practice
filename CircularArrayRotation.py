...
k = 2
queries = [1,2]
Here k is the rotation count on a. and queries holds the list of indices to report. First we perform the two rotations [3,4,5] -> [5,3,4] -> [4,5,3]
...
int[q]: the values in the rotated a as requested in 
Input Format
